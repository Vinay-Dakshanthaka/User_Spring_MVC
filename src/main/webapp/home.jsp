							...
							<div class="row justify-content-center">
								<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
									...
									<form action="register" method="post" class="mx-1 mx-md-4">
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												<input name="age" type="number" id="form3Example1c"
													class="form-control" /> <label class="form-label"
													for="form3Example1c">Your Age</label>
											</div>
										</div>
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												<input name="phone" type="tel" id="form3Example4c"
													class="form-control" /> <label class="form-label"
													for="form3Example4c">Phone</label>
											</div>
										</div>
										...
										<div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4 text-white">
											<button type="submit" value="register"
												class="btn btn-primary btn-lg">
												<a href="byPhone.jsp">Login by Phone</a>
											</button>
										</div>
									</form>
